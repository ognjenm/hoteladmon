...
?>
    ...
    <div id="wrapper">
        ...
        <ul id="lista">
            <?php echo $form->textField($model,'title',array('class'=>'span12','maxlength'=>200,'id'=>'title','placeholder'=>Yii::t('mx','Title'),'style'=>'border: 0 none; background: none repeat scroll 0 0 transparent;')); ?>

            <?php

            foreach($items as $li){
                echo "<li id='elemento-".$li->id."'>".$li->texto."</li>";
            }
