<?php $provider = $model->accountDebit(); ?>
<div class="inner" id="polizas-grid-inner">
    ...
    <?php $this->widget('bootstrap.widgets.TbExtendedGridView',array(
        ...
        'columns'=>array(
            array(
                'name'=>'date',
                'value'=>'$data->accountDebit->datex'
            ),
            array(
                'name'=>'bank',
                'value'=>'BankAccounts::model()->accountByPk($data->accountDebit->accountBank->id)',
                'filter'=>BankAccounts::model()->listAll()
            ),
            array(
                'name'=>'cheq',
                'value'=>'$data->accountDebit->cheq'
            ),
            array(
                'name'=>'released',
                'value'=>'$data->accountDebit->released'
            ),
            array(
                'name'=>'retirement',
                'value'=>'"$".number_format($data->accountDebit->retirement,2)',
