...
$this->breadcrumbs=array(
        Yii::t('mx','Bank Accounts')=>array('index'),
        Yii::t('mx','Manage'),
    );

    $this->menu=array(
        array('label'=>Yii::t('mx', 'BankAccounts'),'icon'=>'icon-refresh','url'=>array('index')),
...
?>
 ...
 ?>
    ...
    <?php $this->beginWidget('bootstrap.widgets.TbModal', array('id' => 'checkbookModal')); ?>

    <div class="modal-header">
        <a class="close" data-dismiss="modal">
            <?php echo CHtml::image(Yii::app()->theme->baseUrl.'/images/close_green.png'); ?>
        </a>
        <h4><i class="icon-user"></i> <?php echo Yii::t('mx','Assign'); ?></h4>
    </div>
