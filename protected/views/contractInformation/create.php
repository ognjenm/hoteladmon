<?php
    ...
    function isdecimal(service){
        ...
        if(tienepunto) return true;
            ...
            $('#ContractInformation_total_amount').focusout(function() {
                var service=$('#ContractInformation_total_amount').val();
                if(!isdecimal(service)) $('#ContractInformation_total_amount').val(service+'.00');
            });
