...
class Operations extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('operations_group', 'length', 'max'=>45),
			array('datex', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, payment_type, account_id, cheq, datex, released, concept, person, bank_concept, retirement, deposit, balance, iscancelled, vat_commission, commission_fee, charge_bank, baucher, n_operation, n_tarjeta, operations_group', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'operations_group' => Yii::t('mx','Operations Group'),
		);
	}
		...
		return array(
			...
			'buttons' => array(
				...
				'closeOperations' => array(
					...
					'ajaxOptions' => array(
						'data'=>array("ids"=>"js:$.fn.yiiGridView.getChecked('operations-grid','chk').toString()","suma"=>'js:sumaTotal'),
						'beforeSend' => 'function() {
