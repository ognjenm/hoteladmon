...
class Employees extends CActiveRecord
{
    ...
    public function listAll(){
        ...
        foreach($result as $item){
            $lista[$item->id]=$item->first_name." ".$item->middle_name." ".$item->last_name;
        }
    ...
    public function getFullName($id){
        ...
        $employee=$this->model()->findByPk($id);
    ...
    public function getFullAddress($id){
        ...
        if($employee){
            $address=$employee->home_street!="" ? $employee->home_street." " : "";
            $address.=$employee->home_city!="" ? $employee->home_city.", " : "";
            $address.=$employee->home_region!="" ? $employee->home_region.", " : "";
            $address.=$employee->home_country!="" ? $employee->home_country.", " : "";
            $address.=$employee->home_zip!="" ? $employee->home_zip : "";
        }
