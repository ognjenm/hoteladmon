...
/**
 * This is the model class for table "cabana_discount".
 *
 * The followings are the available columns in table 'cabana_discount':
 * @property integer $id
 * @property integer $min
 * @property integer $max
 * @property integer $discount
 */
class CabanaDiscount extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return CabanaDiscount the static model class
	 */
