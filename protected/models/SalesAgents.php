...
/**
 * This is the model class for table "sales_agents".
 *
 * The followings are the available columns in table 'sales_agents':
 * @property integer $id
...
class SalesAgents extends CActiveRecord
{
	 ...
	 * @return SalesAgents the static model class
	 */
