...
$this->breadcrumbs=array(
    Yii::t('mx','System variables')=>array('/cruge/ui/systemupdate'),
    Yii::t('mx','Manage'),
);


$this->pageIcon='icon-cogs';
$this->pageSubTitle=Yii::t('mx','System variables');
?>

<?php

if(Yii::app()->user->hasFlash('systemFormFlash')):
    Yii::app()->user->setFlash('success', '<strong>done!</strong> '.Yii::app()->user->getFlash('systemFormFlash'));
endif;
...
<div class="form-group">
	...
	<hr/>
		...
		<?php echo $form->textArea($model,'terms'
			,array('rows'=>10,'cols'=>50,'class'=>'span12')); ?>
