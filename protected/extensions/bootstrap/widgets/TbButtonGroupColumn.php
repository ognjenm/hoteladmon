        ...
        if ($this->type != 'dropdown') {
            ...
            foreach ($this->buttons as $id => $button) {
                ...
                if (isset($button['icon'])) {
                    ...
                    echo '<li>'. CHtml::link('<i class="' . $button['icon'] . '"></i> '.$label, $url, $options).'</li>';
                } else if (isset($button['imageUrl']) && is_string($button['imageUrl'])) {
                    echo '<li>'. CHtml::link(CHtml::image($button['imageUrl'], $label), $url, $options) .'</li>';
                } else {
                    echo '<li>'.CHtml::link($label, $url, $options).'</li>';
                }
            ...
            ob_end_clean();
            echo "<div class='btn-group'><a class='btn dropdown-toggle' data-toggle='dropdown' href='#'>
            <i class='icon-" . $this->icon . "'></i> <span class='caret'></span></a><ul class='dropdown-menu text-left pull-right'>" . strtr($this->template, $tr) . "</ul></div>";
        }
    }
