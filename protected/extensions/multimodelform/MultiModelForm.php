...
class MultiModelForm extends CWidget
{
    ...
    public $rowWrapper = array(
        'tag' => 'div',
        'htmlOptions' => array('class' => 'control-group mmf_row'),
    );
    ...
    {
		$this->limitText = Yii::t('mx','The limit is reached');
