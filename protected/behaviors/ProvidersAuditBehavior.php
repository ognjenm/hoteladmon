...
class ProvidersAuditBehavior extends CActiveRecordBehavior{
    ...
    public function afterSave($event){
        ...
        if ($this->getOwner()->getIsNewRecord()){
            ...
            $providerId=$this->getOwner()->getIsNewRecord() ? $newattributes['id'] : $oldattributes['id'];
            $this->leaveTrail('CREATE','CREADO',NULL,NULL,$providerId);
        }
    ...
    public function auditAttributes($newattributes, $oldattributes = array()){
        ...
        foreach ($newattributes as $name => $value) {
            ...
            if ($value != $old) {
                $this->leaveTrail($this->getOwner()->getIsNewRecord() ? 'SET' : 'CHANGE', $name, $value, $old,$providerId);
            }
        }
    }
    ...
    public function leaveTrail($action, $name = null, $value = null, $old_value = null,$providerId=null){

        $log                        = new AuditProviders();
