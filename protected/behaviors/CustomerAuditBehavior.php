...
class CustomerAuditBehavior extends CActiveRecordBehavior{
    ...
    public function auditAttributes($newattributes, $oldattributes = array()){
        ...
        $customerId=$this->getOwner()->getIsNewRecord() ? $newattributes['id'] : $oldattributes['id'];
        ...
        foreach ($newattributes as $name => $value) {
            ...
            if ($value != $old) {
                $this->leaveTrail($this->getOwner()->getIsNewRecord() ? 'SET' : 'CHANGE', $name, $value, $old,$customerId);
            }
        }
    }
    ...
    public function leaveTrail($action, $name = null, $value = null, $old_value = null,$customerId=null){

        $log                        = new CustomerAudit();
