...
class OperationsAuditBehavior extends CActiveRecordBehavior{
    ...
    public function auditAttributes($newattributes, $oldattributes = array()){
        ...
        $operationId=$this->getOwner()->getIsNewRecord() ? $newattributes['id'] : $oldattributes['id'];
        ...
        foreach ($newattributes as $name => $value) {
            ...
            if ($value != $old) {
                $this->leaveTrail($this->getOwner()->getIsNewRecord() ? 'SET' : 'CHANGE', $name, $value, $old,$operationId);
            }
        }
    }
    ...
    public function leaveTrail($action, $name = null, $value = null, $old_value = null,$operationId=null){

        $log                        = new AuditOperations();
