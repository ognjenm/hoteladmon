...
class ChargesController extends Controller
{
	...
	public function actionCreate($id)
	{
        ...
        if(Yii::app()->request->isAjaxRequest){
            ...
            if(isset($_POST['Charges'])){
                ...
                $model->attributes=$_POST['Charges'];
	...
	{
        $model=new Charges('search');
        $model->unsetAttributes();  // clear any default values
        if(isset($_GET['Charges']))
        $model->attributes=$_GET['Charges'];
	...
	{
		$model=Charges::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='charges-form')
		{
