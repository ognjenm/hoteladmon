...
?>
    ...
    <?php
    if($model->image !=null){
        echo CHtml::image(Yii::app()->baseUrl."/images/articles/".$model->image,$model->name_article,array('width'=>'300px','height'=>'200px'));
    }else{
        echo CHtml::image(Yii::app()->baseUrl."/images/articles/noImageAvailable",Yii::t('mx','Image No available'),array('width'=>'300px','height'=>'200px'));
    }
